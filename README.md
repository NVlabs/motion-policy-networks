...
also download a pretrained set of weights. [You can download those weights here.](https://zenodo.org/record/8319949/files/mpinets_hybrid_expert.ckpt?download=1)
...
We have three sets of test problems that you can download--[those solvable by the Global Planner](https://zenodo.org/record/8319949/files/global_solvable_problems.pkl?download=1),
[those solvable by the Hybrid Planner](https://zenodo.org/record/8319949/files/hybrid_solvable_problems.pkl?download=1), and [those solvable by both planners](https://zenodo.org/record/8319949/files/both_solvable_problems.pkl?download=1).
...
data here.](https://zenodo.org/record/8319949/files/mpinets_real_point_cloud_data.npy?download=1)
...
model in Motion Policy Networks. [You can download this data here](https://zenodo.org/record/8319949/files/mpinets_hybrid_training_data.tar.gz?download=1).
